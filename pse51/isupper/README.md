...
The `isupper()` [CX] and `isupper_l()` functions shall test whether `c` is a character of class **upper** in the current locale, [CX] or in the locale represented by `locale`, respectively; see XBD [7. Locale](https://pubs.opengroup.org/onlinepubs/9799919799/basedefs/V1_chap07.html#tag_07).
