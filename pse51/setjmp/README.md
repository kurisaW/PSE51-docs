...
A call to `setjmp()` shall save the calling environment in its `env` argument for later use by [`longjmp()`](https://pubs.opengroup.org/onlinepubs/9799919799/functions/longjmp.html).
