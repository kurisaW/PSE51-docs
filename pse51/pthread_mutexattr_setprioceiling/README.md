...
The `pthread_mutexattr_getprioceiling()` and `pthread_mutexattr_setprioceiling()` functions, respectively, shall get and set the priority ceiling attribute of a mutex attributes object pointed to by `attr` which was previously created by the function [`pthread_mutexattr_init()`](https://pubs.opengroup.org/onlinepubs/9799919799/functions/pthread_mutexattr_init.html).
