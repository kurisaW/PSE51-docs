...
[Scheduling Policies], `clock_getcpuclockid()`, `clock_nanosleep()`, `ctime()`, `mq_receive()`, `mq_send()`, `nanosleep()`, `pthread_mutex_clocklock()`, `sem_clockwait()`, `thrd_sleep()`, `time()`, `timer_create()`, `timer_getoverrun()`
