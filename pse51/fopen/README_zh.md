...
ISO C 标准要求独占访问"在底层文件系统支持独占访问的范围内"，但没有定义���意味什么。按字面理解——系统必须在文件系统级别尽其所能来排除他人的访问——这将要求 POSIX.1 系统以防止其他用户和组访问的方式设置文件权限。因此，本 POSIX.1-2024 卷在"独占访问"要求方面不遵循 ISO C 标准。
